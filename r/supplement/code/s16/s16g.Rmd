...
```{r}
# read in the data 
df <- read.csv('../../data/endpoint_data_motion_excluded.csv')
```
...
a<- func_correlation_matrix_across_subs(df,"kid",roilist,'lh',sc,1,0) 
b<- func_correlation_matrix_across_subs(df,"adult",roilist,'lh',sc,1,0) 
a+b

# save to figures folder
ggsave(filename = "s16g.png",
        width = 8,
         height = 3)

ggsave(filename = "s16g.pdf",
        width = 8,
         height = 3)
```
