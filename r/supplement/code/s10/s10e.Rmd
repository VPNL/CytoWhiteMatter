...
```{r}
# read in the data 
df <- read.csv('../../data/fascicle_data_motion_excluded.csv')
```
...
a<- func_correlation_matrix_across_subs(df,"kid",roilist,'lh',sc,0) 
b<- func_correlation_matrix_across_subs(df,"adult",roilist,'lh',sc,0) 
a+b

# save to figures folder
ggsave(filename = "s10e.png",
        width = 8,
         height = 3)

# save to figures folder
ggsave(filename = "s10e.pdf",
        width = 8,
         height = 3)
```
