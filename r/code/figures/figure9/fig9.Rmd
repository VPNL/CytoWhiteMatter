...
# save 
ggsave(filename = 
           paste0("fig9_",roiname,".png"),
        width = 4,
         height = 3)

ggsave(filename = 
           paste0("fig9_",roiname,".pdf"),
        width = 4,
         height = 3)
}
```
...
```{r}
roinames = c("mOTS-words","pOTS-words","mFus-faces","pFus-faces","OTS-bodies","CoS-places")

for (r in roinames){
      func_fascicle_plot_single_roi(df,"lh","kid",r)
  }
```